...
#            	    set(CMAKE_BUILD_TYPE Release_Debug CACHE STRING "" FORCE)
	...
	elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
		...
		if(${ARCHITECTURE} STREQUAL "x86")
		  set(EXTERNAL_DIR "${CMAKE_SOURCE_DIR}/linux32")
		elseif(${ARCHITECTURE} STREQUAL "x64")
		  set(EXTERNAL_DIR "${CMAKE_SOURCE_DIR}/linux64")
		else()
			message("Unsupported architecture: ${SYSTEM_ARCHITECTURE}")
		endif()
		set( CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -std=c++17 -fconcepts")
		set( CMAKE_CXX_FLAGS_RELEASE_DEBUG "${CMAKE_CXX_FLAGS_RELEASE_DEBUG} -std=c++17 -fconcpets")
		set( CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -std=c++17 -fconcepts")
